      ...
      <Box sx={{ p: 3 }}>
        ...
        <Grid container spacing={3} sx={{ mb: 3 }}>
          <Grid item xs={12} sm={4}>
            <Card sx={{ borderRadius: '8px', boxShadow: 'none', border: '1px solid #e0e0e0' }}>
              <CardContent>
                ...
                <Typography variant="h4" fontWeight="bold" sx={{ mb: 0.5 }}>1250</Typography>
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                  <TrendingDownIcon color="error" fontSize="small" />
                  <Typography variant="body2" color="error" sx={{ ml: 0.5 }}>-10%</Typography>
                  <Typography variant="body2" color="text.secondary" sx={{ ml: 0.5 }}>compared to last month</Typography>
                </Box>
                <LinearProgress variant="determinate" value={70} sx={{ height: 5, borderRadius: 5 }} />
              </CardContent>
            </Card>
          </Grid>
          <Grid item xs={12} sm={4}>
            <Card sx={{ borderRadius: '8px', boxShadow: 'none', border: '1px solid #e0e0e0' }}>
              <CardContent>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
                  <Typography variant="subtitle1" color="text.secondary">New Users</Typography>
                  <IconButton size="small" sx={{ color: '#555' }}>
                    <TrendingUpIcon />
                  </IconButton>
                </Box>
                <Typography variant="h4" fontWeight="bold" sx={{ mb: 0.5 }}>24</Typography>
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                  <TrendingUpIcon color="success" fontSize="small" />
                  <Typography variant="body2" color="success" sx={{ ml: 0.5 }}>+5%</Typography>
                  <Typography variant="body2" color="text.secondary" sx={{ ml: 0.5 }}>compared to last month</Typography>
                </Box>
                <LinearProgress variant="determinate" value={80} sx={{ height: 5, borderRadius: 5 }} />
              </CardContent>
            </Card>
          </Grid>
          <Grid item xs={12} sm={4}>
            <Card sx={{ borderRadius: '8px', boxShadow: 'none', border: '1px solid #e0e0e0' }}>
              <CardContent>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
                  <Typography variant="subtitle1" color="text.secondary">Totall Users</Typography>
                  <IconButton size="small" sx={{ color: '#555' }}>
                    <BarChartIcon />
                  </IconButton>
                </Box>
                <Typography variant="h4" fontWeight="bold" sx={{ mb: 0.5 }}>1301</Typography>
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                  <TrendingUpIcon color="success" fontSize="small" />
                  <Typography variant="body2" color="success" sx={{ ml: 0.5 }}>+40%</Typography>
                  <Typography variant="body2" color="text.secondary" sx={{ ml: 0.5 }}>compared to last month</Typography>
                </Box>
                <LinearProgress variant="determinate" value={90} sx={{ height: 5, borderRadius: 5 }} />
              </CardContent>
            </Card>
          </Grid>
        </Grid>
                ...
                {(rowsPerPage > 0
                  ...
                  >
                    ...
                    <TableCell component="th" scope="row">
                      <Typography variant="subtitle1" fontWeight="medium">{row.userName}</Typography>
                    </TableCell>
